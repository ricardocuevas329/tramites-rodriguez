...
return [
    ...
    |
    */
    'indisposable' => 'Correo No Permitido!.',
    ...
    */
    ...
    'custom' => [
        's_nombre' => [
            'unique' => 'El campo Nombre ya ha sido Tomado, Ingrese Otro!',
        ],
        'nombre' => [
            'unique' => 'El Nombre ya ha sido Tomado, Ingrese Otro!',
        ],
        's_user' => [
            'unique' => 'El usuario ya ha sido Tomado, Ingrese Otro!',
        ],
        's_telefono' => [
            'numeric' => 'Debe ser Numerico',
        ],
        'password2' => [
            'in' => 'Las claves no coinciden',
        ],
        's_codigo' => [
            'unique' => 'El código ya ha sido tomado, Ingrese Otro!',
        ],
        's_pais' => [
            'unique' => 'Este País ya ha sido tomado, Ingrese Otro!',
        ],
        's_mail' => [
            'unique' => 'Este Email ya ha sido tomado, Ingrese Otro!',
        ],
        'name' => [
            'unique' => 'Este Nombre ya ha sido tomado, Ingrese Otro!',
        ],
        's_nombres' => [
        ...
        'roles' => [
            'min' => 'Seleccione al menos 1 Rol!',
        ],
        'permissions' => [
            'min' => 'Seleccione al menos 1 Permiso!',
        ],
        's_tipo_docu' => [
        ...
        's_numero' => [
            ...
            'min' => [
                'numeric' => 'El campo Numero Documento debe tener al menos :min.',
                'file' => 'El campo Numero Documento debe tener al menos :min kilobytes.',
                'string' => 'El campo Numero Documento debe tener al menos :min caracteres.',
                'array' => 'El campo Numero Documento debe tener al menos :min elementos.',
            ],
        ],
        'd_fecha_sal' => [
            'required' => 'Fecha de Salida es Obligatorio!',

        ],
        'd_fecha_ret' => [
            'required' => 'Fecha de Retorno es Obligatorio!',
            'after_or_equal' => 'La Fecha de Retorno debe ser una fecha después o igual a la Fecha de Salida',
        ],
         'i_numero' => [
            'required' => 'Formato es Requerido!',
             'max' => 'El campo Formato debe tener menos de :max caracteres.',
        ],
        's_direccion' => [

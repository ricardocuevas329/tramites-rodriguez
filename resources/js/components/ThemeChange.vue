...
<template>
  <div title="Cambiar Tema" class=" dropdown-end dropdown z-10 ">
    ...
    <div
      class="scrollbar dropdown-content rounded-t-box rounded-b-box top-px mt-16 h-[70vh] max-h-96 w-40 overflow-y-auto bg-base-200 text-base-content shadow-2xl"
    >
      <div class="grid grid-cols-1 gap-2 p-1" tabindex="0">
        <div
        ...
        >
          ...
          >
            <div class="grid grid-cols-5 grid-rows-3">
              <div class="col-span-5 row-span-3 row-start-1 flex gap-1 py-1 px-2">

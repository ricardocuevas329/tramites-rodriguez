...
<div class="px-6 pt-6 2xl:container">
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div class="md:col-span-2 lg:col-span-1" >
                <div class="h-full py-8 px-6 space-y-6 rounded-xl dark:bg-gray-800  bg-white">
...
<path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor"/>
            ...
            <div>
                <div class="h-full py-6 px-6 rounded-xl dark:bg-gray-800  bg-white">
                    <h5 class="text-xl dark:text-gray-600 text-gray-700">Downloads</h5>
                    <div class="my-8">
                        <h1 class="text-5xl font-bold dark:text-gray-600 text-gray-800">64,5%</h1>
            ...
            <div>
                <div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl dark:bg-gray-800  bg-white">
...
<script setup lang="ts">
 import { configReporte } from '../../../router/Reporte/ReportConfig';
